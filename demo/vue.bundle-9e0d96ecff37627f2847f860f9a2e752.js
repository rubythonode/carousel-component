...
var Vue = _interopDefault(__webpack_require__(29));
...
var vue_class_component_1 = __webpack_require__(52);
var common = __webpack_require__(30);
var variables_1 = __webpack_require__(85);
var Carousel = (function (_super) {
    ...
    Carousel.prototype.beforeMount = function () {
    ...
    Carousel.prototype.moveLeft = function (num) {
        ...
        common.runAnimation(this.$refs.ul, this.timeout, "move-left", num, function () {
            _this.currentIndex -= num;
            if (_this.currentIndex < _this.actualCount) {
                _this.currentIndex += _this.data.length - _this.actualCount * 2;
            }
        });
    };
    Carousel.prototype.moveRight = function (num) {
        var _this = this;
        this.setStyle(num, this.width);
        common.runAnimation(this.$refs.ul, this.timeout, "move-right", num, function () {
            _this.currentIndex += num;
            if (_this.currentIndex >= _this.data.length - _this.actualCount) {
                _this.currentIndex -= _this.data.length - _this.actualCount * 2;
            }
        });
    };
...
CarouselItem = tslib_1.__decorate([
    vue_class_component_1.default({
